    ...
    <div className="app-container">
      ...
      <div className="sidebar">
        <div className="sidebar-header">
          <div className="logo">
            <Trophy size={24} />
            <span className="logo-text">FPL Dashboard</span>
          </div>
        </div>
        ...
        <nav className="sidebar-nav">
          {navigationItems.map((item) => (
            ...
            >
              ...
              {activeNav === item.id && <ChevronRight size={16} className="nav-indicator" />}
            </button>
          ))}
        </nav>
        ...
        <div className="sidebar-footer">
          <div className="user-info">
            <div className="user-avatar">FPL</div>
            <div className="user-details">
              <span className="user-name">Fantasy Manager</span>
              <span className="user-rank">Overall Rank: #-</span>
            </div>
          </div>
